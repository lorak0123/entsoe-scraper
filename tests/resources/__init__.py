...
RESOURCES_CONFIG = [
    {
        ...
        "expected_columns": ["SOLAR_PRODUCTION", "WIND_OFFSHORE_PRODUCTION", "WIND_ONSHORE_PRODUCTION"],
    ...
    },
    {
        ...
        "expected_columns": [
            "BIOMASS_PRODUCTION",
            "FOSSIL_BROWN_COAL_LIGNITE_PRODUCTION",
            "FOSSIL_COAL_DERIVED_GAS_PRODUCTION",
            "FOSSIL_GAS_PRODUCTION",
            "FOSSIL_HARD_COAL_PRODUCTION",
            "FOSSIL_OIL_PRODUCTION",
            "HYDRO_PUMPED_STORAGE_PRODUCTION",
            "HYDRO_PUMPED_STORAGE_CONSUMPTION",
            "HYDRO_RUN_OF_RIVER_POUNDAGE_PRODUCTION",
            "HYDRO_WATER_RESERVOIR_PRODUCTION",
            "OTHER_PRODUCTION",
        ...
        "expected_rows": {
            "BIOMASS_PRODUCTION": 96,
            "FOSSIL_BROWN_COAL_LIGNITE_PRODUCTION": 96,
            "FOSSIL_COAL_DERIVED_GAS_PRODUCTION": 96,
            "FOSSIL_GAS_PRODUCTION": 96,
            "FOSSIL_HARD_COAL_PRODUCTION": 96,
            "FOSSIL_OIL_PRODUCTION": 96,
            "HYDRO_PUMPED_STORAGE_PRODUCTION": 21,  # Only 21 values for this type
            "HYDRO_PUMPED_STORAGE_CONSUMPTION": 86,  # Only 21 values for this type
            "HYDRO_RUN_OF_RIVER_POUNDAGE_PRODUCTION": 86,  # Only 86 values for this type
            "HYDRO_WATER_RESERVOIR_PRODUCTION": 68,  # Only 68 values for this type
            "OTHER_PRODUCTION": 96,
            "OTHER_RENEWABLE_PRODUCTION": 96,
            "SOLAR_PRODUCTION": 57,  # Only 57 values for this type
            "WIND_ONSHORE_PRODUCTION": 96,
        },
