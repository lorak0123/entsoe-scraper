"""Module containing the DocumentType enum, which represents various types of documents used in the ENTSO-E API."""
...
class DocumentType(CodeBinding):
    ...
    Attributes:
        ...
        AGGREGATED_NETTED_EXTERNAL_TSO_SCHEDULE_DOCUMENT (str): Aggregated netted external TSO
            schedule document (code 'B17').
