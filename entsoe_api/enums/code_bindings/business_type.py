"""Module for the BusinessType enum in the ENTSO-E API.

This module defines the `BusinessType` enum, which represents various types of business processes in the ENTSO-E API.
"""
